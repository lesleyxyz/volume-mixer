...
namespace VolumeMixer
{
    ...
    public sealed class AudioSession : IAudioSession, IDisposable
    {
        ...
        public float Volume
        {
            get {
                float vol;
                ((AudioUtilities.ISimpleAudioVolume)_ctl).GetMasterVolume(out vol);
                return vol;
            }
            set { ((AudioUtilities.ISimpleAudioVolume)_ctl).SetMasterVolume(value, new Guid()); }
        }
